...
public class CountrySpinnerAdapter extends ArrayAdapter<Country> implements SpinnerAdapter, Filterable {
    ...
    public View getDropDownView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.mImageView = convertView.findViewById(R.id.international_phone_input_country_flag);
            viewHolder.mNameView = convertView.findViewById(R.id.international_phone_input_country_name);
            viewHolder.mDialCode = convertView.findViewById(R.id.international_phone_input_country_dial_code);
