...
/**
 * An activity representing a single LoyaltyProgram detail screen. This
 * activity is only used on narrow width devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link LoyaltyProgramListActivity}.
 */
public class LoyaltyProgramDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loyaltyprogram_detail);
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(LoyaltyProgramDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(LoyaltyProgramDetailFragment.ARG_ITEM_ID));
