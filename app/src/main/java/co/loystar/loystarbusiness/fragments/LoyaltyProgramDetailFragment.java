...
public class LoyaltyProgramDetailFragment extends Fragment {
    ...
    /**
     * The loyalty program this fragment is presenting.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.loyaltyprogram_detail, container, false);

        /*// Show the dummy content as text in a TextView.
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.loyaltyprogram_detail)).setText(mItem.details);
        }*/
